						...
						<>
							...
							<div className="classes event">
								<div className="no-schedule-message">
									...
									<div>Тишина перед бурей интересных событий</div>
									<div className="schedule-details">Новые мероприятия появятся здесь в ближайшее время</div>
								</div>
							</div>
							<div></div>
						</>
